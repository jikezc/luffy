    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_show_list', models.BooleanField(default=False, verbose_name='是否展示到列表页中')),
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courselessons', to='courses.Course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '课程课时',
